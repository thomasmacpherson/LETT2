...
def test_i2c():
    ...
    driver1 = LCD_23017(bus=smbus.SMBus(1), addr=0x20, port='A', rs=0, en=1)
    driver2 = LCD_23017(bus=smbus.SMBus(1), addr=0x20, port='A', rs=0, en=2)
    driver3 = LCD_23017(bus=smbus.SMBus(1), addr=0x20, port='A', rs=0, en=3)
