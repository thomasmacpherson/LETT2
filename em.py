...
class em:
	...
	def writeLCD(self, LCD, line, message):
		...
		if LCD <4:
			print "here"
			self.pygame.draw.rect(self.screen, (0,0,200),(const.LCDX+5, const.LCDY[LCD]+9+(LCD*(const.LCDInnerHeight/2)),const.LCDInnerWidth, const.LCDInnerHeight/2),0) # draw over previous text
			displayText = self.font.render(message ,1, (0,0,0)) #black
			self.screen.blit(displayText, (const.LCDXtext, const.LCDYtext[LCD][line]))			
			
		elif LCD == 4:
			self.pygame.draw.rect(self.screen, (0,0,200),(const.LCDX+5, const.LCDY[0]+9+(LCD*(const.LCDInnerHeight/2)),const.LCDInnerWidth, const.LCDInnerHeight/2),0) # draw over previous text
			displayText = self.font.render(message ,1, (0,0,0)) #black
			self.screen.blit(displayText, (const.LCDXtext, const.LCDYtext[0][0]))
			
			self.pygame.draw.rect(self.screen, (0,0,200),(const.LCDX+5, const.LCDY[1]+9+(LCD*(const.LCDInnerHeight/2)),const.LCDInnerWidth, const.LCDInnerHeight/2),0) # draw over previous text
			displayText = self.font.render(message ,1, (0,0,0)) #black
